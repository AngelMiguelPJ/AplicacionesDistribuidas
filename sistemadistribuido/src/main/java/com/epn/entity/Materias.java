...
@NamedQueries({
    ...
    , @NamedQuery(name = "Materias.findByPrecio", query = "SELECT m FROM Materias m WHERE m.precio = :precio")})
public class Materias implements Serializable {
    ...
    public Materias(Integer codigo) {
        this.codigo = codigo;
    }

    public Materias(Integer codigo, String nombre, BigDecimal precio) {
        this.codigo = codigo;
        this.nombre = nombre;
        this.precio = precio;
    }
    ...
    public String toString() {
        return "com.epn.entity.Materias[ codigo=" + codigo + " ]";
    }
